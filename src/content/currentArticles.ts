...
function article(
  ...
  return {
    ...
    published,
    author: 'Maya Bennett',
    authorBio: 'Maya reports on brand strategy, campaign systems, and the technology changing creative work.',
...
export const currentNewsArticles: NewsArticle[] = [
  article({
    ...
    category: 'AI',
    topics: ['tech', 'ai'],
    hero: 'https://cdn.pixabay.com/photo/2016/11/29/03/53/art-1867071_1280.jpg',
  ...
  article({
    ...
    hero: 'https://cdn.pixabay.com/photo/2016/03/05/19/02/hamburger-1238246_1280.jpg',
  ...
  article({
    ...
    hero: 'https://cdn.pixabay.com/photo/2016/11/29/04/17/audio-1867121_1280.jpg',
  ...
  article({
    ...
    title: 'State Farm Gives Real Football Fans the Supporting Role in Its New Spots',
    excerpt: 'The insurer pairs recognizable athletes with authentic supporters to keep celebrity-led advertising grounded in everyday fandom.',
    category: 'Marketing',
    topics: ['marketing', 'advertising', 'branding'],
    hero: 'https://cdn.pixabay.com/photo/2017/07/31/11/21/people-2557396_1280.jpg',
    heroAlt: 'Group of enthusiastic people gathered together as sports supporters',
    lead: 'State Farm’s latest football creative balances star power with the reactions of ordinary supporters. The fans are not anonymous extras; their behavior provides the comic timing and social credibility around the athletes.',
    analysis: 'Celebrity campaigns often lose energy when every scene bends around the endorsement. Giving fans a real role restores tension and makes the brand feel present in football culture rather than simply buying access to it.',
    lesson: 'A recognizable spokesperson can attract the first look, but believable community behavior earns the second. Casting should represent how customers actually talk, celebrate, and tease one another.',
  }),
  article({
    ...
    hero: 'https://cdn.pixabay.com/photo/2015/05/31/10/55/manufacture-791202_1280.jpg',
  ...
  article({
    ...
    hero: 'https://cdn.pixabay.com/photo/2015/05/15/14/47/computer-768696_1280.jpg',
